...
;         :match-multiple  ; If the value is :all, then referents for a child
                           ; should match all matches, not just one exemplar.
                           ; If the value is :exclusive, then referents for
                           ; a child should match all matches that match the
                           ; child and that don't match any of the child's
                           ; siblings that are not more general. See
