...
(deftest empty-to-nil-test
  (is (= (empty-to-nil #{}) nil))
  (is (= (empty-to-nil nil) nil))
  (is (= (empty-to-nil {}) nil))
  (is (= (empty-to-nil []) nil))
  (is (= (empty-to-nil {1 2 3 4}) {1 2 3 4})))
...
(deftest update-in-collapse-empty-test
  (is (empty (update-in-collapse-empty {:a {:b {:c 1}}} [:a :b :c]
                                       (constantly nil))))
    (is (empty (update-in-collapse-empty {:a {:b {:c 1}}} [:a :b :c]
                                       (constantly #{}))))
  (is (= (update-in-collapse-empty {:a {:b {:c 1}}} [:a :b :d] (constantly nil))
         {:a {:b {:c 1}}}))
  (is (= (update-in-collapse-empty  {:a {:b {:c 1}}} [:a :b :c] inc)
         {:a {:b {:c 2}}}))
  (is (= (update-in-collapse-empty  {:a {:b {:c 1}}} [:a :b :d]  (constantly 2))
         {:a {:b {:c 1 :d 2}}}))
  (is (= (update-in-collapse-empty  {:a {:b {:c 1}}} [:a :b :d]  (constantly 2))
         {:a {:b {:c 1 :d 2}}})))
