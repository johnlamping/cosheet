...
(deftest vector-test
  ...
  (let [name-label `(~(id->object (make-item-id "name") nil))]
    ...
    (is (anonymous-object? [:object `("" ~name-label)]))
    ...
    (is (not (named-object? [:object `("" ~name-label)])))
