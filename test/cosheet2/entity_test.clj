...
(deftest vector-test
  ...
  (is (= (entity-type [:object 1 2]) :object))
...
(deftest constant-test
  ...
  (is (= (entity-type 1) :primitive))
  (is (= (entity-type true) :primitive))
  (is (= (entity-type "foo") :primitive))
  (is (= (entity-type :foo) :primitive))
  (is (= (entity-type 'foo) :primitive))
  (is (= (entity-type nil) :primitive))
  (is (= (entity-type orderable/initial) :primitive))
  (is (= (content 1) 1))
