              ...
              [:div (any map?)
               ...
               [:div {:style {:display "table-row"}
                ...
                [:div (any map?)
                 [:component (any map?)
                  [item-DOM
                   bogus-age [(:item-id bogus-age) :joe]
                 ...
                 {:key [labels-ref :joe]
                  ...
                  :row-sibling [[:parallel []
                                 (as-set [(:item-id v1)
                                          ...
                                          (:item-id v13)])]
                                :joe]}
                 [item-DOM L1 [labels-ref :joe]  #{L1-spec} (any map?)]]
               ...
               [:div {:style {:display "table-row"}}
                [:div {:class "column tags" :style {:display "table-cell"}}
                 [:component
                  ...
                  [item-DOM
                   L2 [(:item-id L2) [:elements (:item-id v12) [nil 'tag]]
                       (:item-id v12) :joe]
                   #{L2-spec} (any map?)]]]
               ...
               [:div {:style {:display "table-row"} :class "last-row"}
                [:div {:class "column tags bottom-border"
                 ...
                 [:component
                  ...
                  [item-DOM
                   L3 [(:item-id L3) [:elements (:item-id v13) [nil 'tag]]
                       (:item-id v13) :joe]
                   #{L3-spec} (any map?)]]]
                [:component {:key [(:item-id v13) :joe]
                 ...
                 [item-DOM
                  v13 [(:item-id v13) :joe] #{L131 L3} (any map?)]]]]]))))
